...
instance Yesod App where
    ...
    defaultLayout widget = do
        ...
        pc <- widgetToPageContent $ do
            ...
            -- toWidget $(typeScriptFile "templates/default-layout.julius")
    ...
    isAuthorized (EntryR _) True = isAdmin
    isAuthorized RootEntryR True = isAdmin
...
isAdmin = do
    ...
    return $ case muser of
        ...
        Just user -> if isAdminUser user 
                     then Authorized
                     else Unauthorized "You must be an admin"

authToBool :: AuthResult -> Bool
authToBool auth = case auth of
